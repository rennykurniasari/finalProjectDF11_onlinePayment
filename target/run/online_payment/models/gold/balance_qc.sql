    ...
    create or replace table `final-project-404104`.`online_payment_marts`.`balance_qc`
    ...
    as (
      WITH source AS (
  SELECT *
  FROM `final-project-404104`.`online_payment_transformed`.`svr_balancing_transactions`
),
