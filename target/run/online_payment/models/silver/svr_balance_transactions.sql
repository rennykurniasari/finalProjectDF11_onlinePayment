    ...
    create or replace table `final-project-404104`.`online_payment_transformed`.`svr_balance_transactions`
...
balance_transaction AS (
    ...
    UPDATE `final-project-404104`.`online_payment_transformed`.`svr_imbalance_transactions`
    SET newbalanceOrig = 
        CASE
